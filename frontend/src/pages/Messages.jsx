...
function MessagesInner() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden">
      ...
      {/* Chat Area */}
      <div className="flex-1 flex flex-col h-full pl-1 min-w-0 bg-white dark:bg-gray-800">
        {/* Chat Header */}
        {selectedChat && selectedChat.user ? (
          ...
          <div className="h-16 flex items-center px-6 border-b border-gray-200 dark:border-gray-700 text-gray-500 flex-shrink-0">
